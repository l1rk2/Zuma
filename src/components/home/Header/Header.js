          ...
          <div>
            {showMenu && (
              <motion.ul
                ...
                className="flex items-center w-auto z-50 p-1 gap-2"
              >
                <>
                  ...
                  <div className="w-full h-full bg-primeColor p-6">
                    ...
                    <div className="mt-4">
                      ...
                      {category && (
                        ...
                        >
                          <li className="headerSedenavLi">Нові надходження</li>
                          <li className="headerSedenavLi">Gudgets</li>
                          <li className="headerSedenavLi">Аксесуари</li>
                          <li className="headerSedenavLi">Електроніка</li>
                          <li className="headerSedenavLi">Інші</li>
                        </motion.ul>
                      )}
                    </div>
                    <div className="mt-4">
                      ...
                      {brand && (
                        ...
                        >
                          <li className="headerSedenavLi">Нові надходження</li>
                          <li className="headerSedenavLi">Гаджети</li>
                          <li className="headerSedenavLi">Аксесуари</li>
                          <li className="headerSedenavLi">Електроніка</li>
                          <li className="headerSedenavLi">Інші</li>
                        </motion.ul>
