...
const tabs = [
  {
    id: "Fiche Technique",
    label: "Техніка характеристики",
    content:
      "15.6 (1920x1080) IPS / Intel Core i7-12650H (3.5 - 4.7 ГГц) / RAM 16 ГБ / SSD 512 ГБ / nVidia GeForce RTX 30504 ГБ / без ОД / LAN / Wi-Fi / Bluetooth / веб-камера / DOS / 1.86 кг",
  },
  {
    id: "Description",
    label: "Опис",
  ...
  },
  {
    ...
    content: (
      <iframe
        width="560"
        height="315"
        src="https://youtu.be/0mkLjCv33D8?si=0TpOEO2TWQ35T8Lr"
        title="YouTube Video"
        frameBorder="0"
        allowFullScreen
      ></iframe>
