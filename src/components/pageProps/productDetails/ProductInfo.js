  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      <div className="flex items-center">
        <p className="text-sm mr-2"> залишити відгук </p>
      ...
      <p className="text-base text-green-600 font-medium">На складі</p>
      <p className="font-medium text-lg">
        <span className="font-normal">Кольора:</span> {productInfo.color}
      </p>
      <button
        onClick={() =>
          dispatch(
      ...
      <p className="font-normal text-sm">
        <span className="text-base font-medium"> Категорії:</span> ноутбуки / ігровий ноутбуки
      </p>
    </div>
  );
};
